...
public class MealTestData {
    ...
    public static final int MEAL2_ID = START_SEQ + 13;
    ...
    public static final Meal userMeal1 = new Meal(MEAL2_ID, of(2020, Month.JANUARY, 31, 15, 0), "Юзер ланч", 610,UserTestData.userWithMeal);
    public static final Meal userMeal2 = new Meal(MEAL2_ID + 1, of(2020, Month.JANUARY, 31, 21, 0), "Юзер ужин", 1200,UserTestData.userWithMeal);
